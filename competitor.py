...
class Competitor:
    ...
    def asdict(self):
        status = "valid"
        if self.dns: status = "DNS"
        elif self.dnf: status = "DNF"
        elif self.dsq: status = "DSQ"

        return {
            "first_name": self.etunimi,
            "last_name": self.sukunimi,
            "club": self.seura,
            "competition_class": self.kilpasarja,
            "bib_number": self.bibnumber,
            "times": self.ajat,
            "result": self.sijoitus,
            "status": status
            }
